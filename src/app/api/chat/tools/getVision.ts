...
export const getVision = tool({
  ...
  parameters: z.object({}),
  async execute() {
    return "My vision is to collaborate with forward‑thinking organizations to tackle global challenges using intelligent systems. I'm particularly driven to transform road and traffic safety through AI and data‑driven engineering. Inspired by the engineering excellence of autonomous‑vehicle pioneers like Waymo, I aim to build solutions that enhance transportation safety and reliability.";
  },
});